            ...
            <div className="grid lg:grid-cols-2 gap-8 items-center relative z-10">
              <div className="space-y-4 text-sm text-gray-400">
                ...
                <div className="flex flex-wrap gap-x-4 gap-y-2 pt-2">
                  <a href="https://github.com/kishankumarkishan573-web/Reality/blob/main/app/src/main/java/com/neubofy/reality/services/AppBlockerService.kt" target="_blank" rel="noopener noreferrer" className="text-neural-cyan hover:underline font-mono text-xs flex items-center gap-1">AppBlockerService.kt <ArrowUpRight size={12}/></a>
                  <a href="https://github.com/kishankumarkishan573-web/Reality/blob/main/app/src/main/java/com/neubofy/reality/ui/activity/StrictModeActivity.kt" target="_blank" rel="noopener noreferrer" className="text-neural-cyan hover:underline font-mono text-xs flex items-center gap-1">StrictModeActivity.kt <ArrowUpRight size={12}/></a>
                </div>
              </div>
          ...
          <div className="bg-neural-card border border-gray-800 p-4 sm:p-8 rounded-2xl relative overflow-hidden group">
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-center relative z-10">
              <div className="space-y-4 text-sm text-gray-400">
                ...
                <div className="pt-2">
                  <a href="https://github.com/kishankumarkishan573-web/Reality/blob/main/app/src/main/java/com/neubofy/reality/data/" target="_blank" rel="noopener noreferrer" className="text-neural-cyan hover:underline font-mono text-xs flex items-center gap-1">Reality Room Database Package <ArrowUpRight size={12}/></a>
                </div>
              </div>
          ...
          <div className="bg-neural-card border border-gray-800 p-4 sm:p-8 rounded-2xl relative overflow-hidden group">
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-center relative z-10">
              <div className="space-y-4 text-sm text-gray-400">
                ...
                <div className="pt-2">
                  <a href="https://github.com/kishankumarkishan573-web/Reality/blob/main/app/src/main/java/com/neubofy/reality/google/GoogleDriveManager.kt" target="_blank" rel="noopener noreferrer" className="text-neural-cyan hover:underline font-mono text-xs flex items-center gap-1">GoogleDriveManager.kt <ArrowUpRight size={12}/></a>
                </div>
              </div>
              <div className="bg-black/60 p-6 rounded-xl border border-gray-800 flex items-center justify-between overflow-x-auto">
          ...
          <div className="bg-neural-card border border-gray-800 p-4 sm:p-8 rounded-2xl relative overflow-hidden group">
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-center relative z-10">
              <div className="space-y-4 text-sm text-gray-400">
                ...
                <div className="flex flex-wrap gap-x-4 gap-y-2 pt-2">
                  <a href="https://github.com/kishankumarkishan573-web/Reality/blob/main/app/src/main/java/com/neubofy/reality/google/GoogleCalendarManager.kt" target="_blank" rel="noopener noreferrer" className="text-neural-cyan hover:underline font-mono text-xs flex items-center gap-1">GoogleCalendarManager.kt <ArrowUpRight size={12}/></a>
                  <a href="https://github.com/kishankumarkishan573-web/Reality/blob/main/app/src/main/java/com/neubofy/reality/google/GoogleTasksManager.kt" target="_blank" rel="noopener noreferrer" className="text-neural-cyan hover:underline font-mono text-xs flex items-center gap-1">GoogleTasksManager.kt <ArrowUpRight size={12}/></a>
                </div>
              </div>
              <div className="bg-black/60 p-6 rounded-xl border border-gray-800 flex items-center justify-between overflow-x-auto">
          ...
          <div className="bg-neural-card border border-gray-800 p-4 sm:p-8 rounded-2xl relative overflow-hidden group">
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-center relative z-10">
              <div className="space-y-4 text-sm text-gray-400">
                ...
                <div className="pt-2">
                  <a href="https://github.com/kishankumarkishan573-web/Reality/blob/main/workers/identity/worker.js" target="_blank" rel="noopener noreferrer" className="text-neural-cyan hover:underline font-mono text-xs flex items-center gap-1">workers/identity/worker.js <ArrowUpRight size={12}/></a>
                </div>
              </div>
              <div className="bg-black/60 p-6 rounded-xl border border-gray-800 flex items-center justify-between overflow-x-auto">
          ...
          <div className="bg-neural-card border border-gray-800 p-4 sm:p-8 rounded-2xl relative overflow-hidden group">
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-center relative z-10">
              <div className="space-y-4 text-sm text-gray-400">
                ...
                <div className="pt-2">
                  <a href="https://github.com/kishankumarkishan573-web/Reality/blob/main/app/src/main/java/com/neubofy/reality/services/TapasyaManager.kt" target="_blank" rel="noopener noreferrer" className="text-neural-cyan hover:underline font-mono text-xs flex items-center gap-1">TapasyaManager.kt <ArrowUpRight size={12}/></a>
                </div>
              </div>
              <div className="bg-black/60 p-6 rounded-xl border border-gray-800 flex items-center justify-between overflow-x-auto">
          ...
          <div className="bg-neural-card border border-gray-800 p-4 sm:p-8 rounded-2xl relative overflow-hidden group">
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-center relative z-10">
              <div className="space-y-4 text-sm text-gray-400">
                ...
                <div className="pt-2">
                  <a href="https://github.com/kishankumarkishan573-web/Reality/blob/main/app/src/main/java/com/neubofy/reality/utils/ToolRegistry.kt" target="_blank" rel="noopener noreferrer" className="text-neural-cyan hover:underline font-mono text-xs flex items-center gap-1">ToolRegistry.kt <ArrowUpRight size={12}/></a>
                </div>
              </div>
              <div className="bg-black/60 p-6 rounded-xl border border-gray-800 flex items-center justify-between overflow-x-auto">
