...
export default async function Home() {
  ...
  try {
      const res = await fetch('https://api.github.com/repos/kishankumarkishan573-web/Reality/releases', {
          next: { revalidate: 360 }
      });
      if (res.ok) {
         ...
         <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 gap-12">
               <div className="space-y-6">
                  ...
                  <div className="pt-2">
                    <a href="https://github.com/kishankumarkishan573-web/Reality/blob/main/app/src/main/java/com/neubofy/reality/google/GoogleAuthManager.kt" target="_blank" rel="noopener noreferrer" className="text-neural-cyan hover:underline font-mono text-xs flex items-center gap-1">
               ...
               <div className="space-y-6">
                  ...
                  <div className="pt-2">
                    <a href="https://github.com/kishankumarkishan573-web/Reality/blob/main/app/src/main/java/com/neubofy/reality/ui/activity/StrictModeActivity.kt" target="_blank" rel="noopener noreferrer" className="text-neural-cyan hover:underline font-mono text-xs flex items-center gap-1">
